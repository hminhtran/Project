                        ...
                        <div class="card-body">
                            <table id="" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = " SELECT nhan_luong.*,nhan_vien.Hoten,luong.Luong_co_ban 
                                    FROM nhan_luong JOIN nhan_vien ON nhan_luong.Ma_nv = nhan_vien.Ma_nv 
                                    JOIN luong ON nhan_luong.He_so_luong = luong.He_so_luong WHERE MONTH(Thoi_gian) = '$month' and YEAR(Thoi_gian) ='$year' 
                                    and  nhan_luong.Ma_nv = '$manv' ";
