                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered table-hover" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT nhan_vien.* FROM nhan_vien where Ma_nv = '$manv'";
                                    ...
                                    ?>
                                                <tr>
                                                    ...
                                                    <td> <button class="btn btn-success" onclick="window.location.href='ql_thuong_phat.php'"><i class="fas fa-eye"></i></button></td>
                                                </tr>
                                            <?php }
