                        ...
                        <div class="card-body">
                            <table id="" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = " SELECT nhan_luong.*,nhan_vien.Hoten,nhan_vien.qr_banking,luong.Luong_co_ban 
                                    FROM nhan_luong JOIN nhan_vien ON nhan_luong.Ma_nv = nhan_vien.Ma_nv
                                     JOIN luong ON nhan_luong.He_so_luong = luong.He_so_luong 
                                     WHERE MONTH(Thoi_gian) = '$month' and YEAR(Thoi_gian) ='$year'";
                                    ...
                                    ?>
                                                <tr>
                                                    <td><a href="#" class="show-image" data-toggle="modal" data-target="#imageModal" data-manv="<?php echo $manv; ?>">
                                                            <?php echo $row['Ma_nv']."- ".$row['Hoten']; ?>
                                                        </a>
                                                        <div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="imageModalLabel">Hình ảnh nhân viên</h5>
                                                            ...
                                                            <img id="imageInModal" src="../../qr_banking/<?php echo $row['qr_banking'];?>" class="img-fluid" alt="Hình ảnh nhân viên trong modal">
